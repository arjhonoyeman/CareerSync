...
<div class="row">
    <div class="col-md-12">
        ...
        <form role="form" method="post" action="<?php echo e(route('company.jobs.update', $job)); ?>">
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="d-flex">
                        <a href="<?php echo e(route('company.jobs.index')); ?>" class="btn btn-secondary"><?php echo app('translator')->get('Cancel'); ?></a>
...
<script src="<?php echo e(Module::asset('jobs:js/employer_jobs.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('core::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp 7.4\htdocs\Modules\Jobs\Providers/../Resources/views/employer_jobs/edit.blade.php ENDPATH**/ ?>