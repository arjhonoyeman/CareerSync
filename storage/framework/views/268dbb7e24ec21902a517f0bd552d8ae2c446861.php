...
<div id="myModal" class="modal">
 ...
 <div id="loadingMessage">
    ...
    <script type="text/javascript">
        ...
        var upload_Image = '<?php echo e(URL::to('resumecv/uploadimage')); ?>';
        ...
        var urlStore = '<?php echo e(URL::to('resumecv/update-builder/'.$data->id)); ?>';
        var urlLoad = '<?php echo e(URL::to('resumecv/load-builder/'.$data->id)); ?>';
        var back_button_url = "<?php echo e(URL::to('resumecv')); ?>";
        var exportPDF_url = "<?php echo e(URL::to('resumecv/download',$data->code)); ?>";
        ...
        var langs = {
          ...
          "exportPdf": "<?php echo app('translator')->get('Download PDF'); ?>",
        };
    </script>
    <script src="<?php echo e(Module::asset('resumecv:js/custom-builder.js')); ?>"></script>
</body>

</html><?php /**PATH C:\xampp7.4.29\htdocs\Modules\ResumeCV\Providers/../Resources/views/resumecv/builder.blade.php ENDPATH**/ ?>