...
<div class="row mt-4">
  <div class="col-sm-8">
      ...
      ?>
      <a href="<?php echo e(url('alltemplates')); ?>" class="btn btn-light <?php if(empty($route_id)): ?> active <?php endif; ?>"><?php echo app('translator')->get("All Templates"); ?></a>
      <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="btn-group" role="group">
            <a class="btn btn-light <?php if($route_id == $category->id): ?> active <?php endif; ?>" href="<?php echo e(url('alltemplates/'). '/' .$category->id); ?>"><?php echo e($category->name); ?></a>
          </div>
          ...
          <div class="clearfix blog-bottom blog blogitemlarge">
              ...
              <div class="content_blog clearfixflex flex-column flex-lg-row">
                  ...
                  <div class="d-flex pt-1">
                      <a href="#" class="btn btn-primary mr-2 btn_builder_template" data-id="<?php echo e($item->id); ?>" data-toggle="modal" data-target="#createModal"><?php echo app('translator')->get("Builder"); ?></a>
                  </div>
              </div>
          </div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="saveandbuilder"><?php echo app('translator')->get('Save & Builder'); ?></button>
      </div>
      </form>
    </div>
  </div>
...
<?php echo $__env->make('core::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4.29\htdocs\Modules\ResumeCV\Providers/../Resources/views/resumecvtemplates/templates.blade.php ENDPATH**/ ?>