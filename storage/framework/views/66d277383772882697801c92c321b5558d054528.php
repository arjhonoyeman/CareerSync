                            ...
                            <tr>
                               ...
                               <td>
                                ...
                                <small><?php echo app('translator')->get('Job Tile'); ?>: 
                                  <a href="<?php echo e(route('company.jobs.edit', $item)); ?>" class="text-dark">
                               ...
                               <td>
                                 <small><strong><?php echo app('translator')->get('Full name'); ?></strong>: <?php echo e($item->fullname); ?></small><br>
                                 <small><strong><?php echo app('translator')->get('Email'); ?></strong>: <?php echo e($item->email); ?></small>
                               </td>
                               ...
                               <small><?php echo e($item->description); ?></small>
                                ...
                                <td>
                                  <div class="d-flex">
                                        ...
                                        <div class="p-1"> 
                                          <form method="post" action="<?php echo e(route('company.applicants.destroy', $item->id)); ?>" onsubmit="return confirm('<?php echo app('translator')->get('Confirm delete?'); ?>');">
                                              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('core::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4.29\htdocs\Modules\Jobs\Providers/../Resources/views/employer_applicants/index.blade.php ENDPATH**/ ?>