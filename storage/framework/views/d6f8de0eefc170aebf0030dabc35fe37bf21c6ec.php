...
<div class="d-sm-flex align-items-center justify-content-between mb-2">
        ...
        <div class="ml-auto d-sm-flex">
          ...
          <a href="<?php echo e(route('company.jobs.create')); ?>" class="btn btn-success">
                ...
                <div class="table-responsive">
                     <table class="table card-table table-vcenter text-nowrap">
                        ...
                        <tbody>            
                            ...
                            <tr>
                               <td>
                                <small><?php echo app('translator')->get('Job Tile'); ?>: <strong><?php echo e($item->title); ?></strong></small><br>
                                <small><?php echo e($item->functional_area->name); ?></small>
                               </td>
                               <td>
                                <?php if(isset($item->city)): ?>
                                <small><?php echo e($item->city->name); ?></small>
                                <?php endif; ?>
                               </td>
                               <td>
                                ...
                                <td>
                                     <div class="d-flex">
                                        <div class="p-1">
                                              <a href="<?php echo e(route('company.jobs.edit', $item)); ?>"><span  class="badge badge-primary"><?php echo app('translator')->get('Edit'); ?></span></a>
                                        </div>
                                        <div class="p-1 ">
                                              <a href="<?php echo e(route('tracklink.show', ['target_class' => 'job', 'target_id' => $item->id])); ?>"><span  class="badge badge-dark"><i class="fas fa-chart-pie"></i> <?php echo app('translator')->get('Statistics'); ?></span></a>
                                        </div>
                                        <div class="p-1">
                                    ...
                                    <div class="d-flex">
                                        <div class="p-1 ">
                                                <form method="post" action="<?php echo e(route('company.jobs.destroy', $item->id)); ?>" onsubmit="return confirm('<?php echo app('translator')->get('Confirm delete?'); ?>');">
                                                    <?php echo csrf_field(); ?>
...
<div class="row">
  <div class="col-lg-12">
    ...
    <div class="text-center">
      ...
      <a href="<?php echo e(route('company.jobs.create')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('core::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp 7.4.28\htdocs\Modules\Jobs\Providers/../Resources/views/employer_jobs/index.blade.php ENDPATH**/ ?>