...
<div class="row">
    <div class="col-md-12">
        ...
        <form role="form" method="post" action="<?php echo e(route('company.jobs.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="card">
                <div class="card-body">
                    <div class="row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('core::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4.29\htdocs\Modules\Jobs\Providers/../Resources/views/employer_jobs/create.blade.php ENDPATH**/ ?>