...
<?php if(config('recaptcha.api_site_key') && config('recaptcha.api_secret_key')): ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php echo $__env->make('themes::default.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4.29\htdocs\Modules\Themes\Providers/../Resources/views/default/contact.blade.php ENDPATH**/ ?>