...
<div class="row">
    <div class="col-md-12">
        ...
        <form role="form" method="post" action="<?php echo e(route('settings.resumecvcategories.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card">
                <div class="card-body">
                    <div class="row">
...
<?php echo $__env->make('core::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp 7.4\htdocs\Modules\ResumeCV\Providers/../Resources/views/resumecvcategories/create.blade.php ENDPATH**/ ?>