...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><?php echo app('translator')->get('Create'); ?></h1>
</div>
<div class="row">
    <div class="col-md-12">

        <form role="form" method="post" action="<?php echo e(route('settings.users.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control" placeholder="<?php echo app('translator')->get('E-mail'); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="role" class="form-control" id="user_role_select">
                                    <option value="candidate"><?php echo app('translator')->get('Candidate'); ?></option>
                                    <option value="employer"><?php echo app('translator')->get('Employer'); ?></option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="package_id" class="form-control">
                                    ...
                                    <option value="<?php echo e($package->id); ?>" <?php echo e($package->id == old('package_id') ? 'selected' : ''); ?>><?php echo e($package->title); ?></option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="package_ends_at" value="<?php echo e(old('package_ends_at')); ?>" placeholder="<?php echo app('translator')->get('Package ends at'); ?>" data-target="#datetimepicker1"/>
                ...
                <div class="card-footer">
                    <div class="d-flex">
                        ...
                        <button class="btn btn-success ml-auto"><?php echo app('translator')->get('Add user'); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('core::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp 7.4\htdocs\Modules\User\Providers/../Resources/views/users/create.blade.php ENDPATH**/ ?>